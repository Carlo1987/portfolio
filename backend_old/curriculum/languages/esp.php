    ...
    'experience' => [
        ...
        'experience' => [
            [
                ...
                'content' => "Desarrollo de aplicaciones como herramientas de presupuestos, configuradores técnicos de cristales y recopilación de registros de dispositivos de salida.
    ...
    'courses' => [
        ...
        'courses' => [
            ...
            [
                ...
                'content' => "Curso Docker"
            ], 

            [
                'name' => 'Master Typescript, JS moderno',
                'date' => translate_hours($courses['master_typescript&js']),
                'content' => "Master Typescipt y Javascript Moderno, ES2024 APIs html5"
            ],
            ...
            [
                ...
                'content' => "Administrar VPS nginx con Letsencrypt"
            ],
            ...
            [
                ...
                'content' => "Cyrso GIT y terminal de comando"
            ],
